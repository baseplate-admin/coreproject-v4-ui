<script lang="ts">
	...
	import HoverExpand from "./hover_expand.svelte";
	import ScrollArea from "./scroll_area.svelte";
	...
	function handle_mouseenter() {
		...
		// udpate position
		is_overflowing =
			main_element_rect.right + dropdown_cont_rect.width + parent_element_gap > window.innerWidth;
	}
</script>
		...
		>
			...
			<div class="text-surface-50 flex w-full items-center md:gap-[0.35vw] md:text-[0.8vw]">
				<div class="flex items-center md:gap-[0.5vw]">
					<Star variant="full" fill_color="red" class="md:w-[0.9vw]" />
