...
test("check classnames", () => {
	...
	// Test true case
	expect(cn(true && "px-2 py-1", "bg-red hover:bg-dark-red", "p-3 bg-[#B91C1C]")).toBe(
		"hover:bg-dark-red p-3 bg-[#B91C1C]"
	);
	expect(
		cn(
	...
	// Test false case
	expect(cn(false && "px-2 py-1", "bg-red hover:bg-dark-red", "bg-[#B91C1C]")).toBe(
		"hover:bg-dark-red bg-[#B91C1C]"
	);
	expect(
		cn(
			(() => {
