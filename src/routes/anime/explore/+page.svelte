<script lang="ts">
	...
	import { Chevron, Expand, SixGrids, Tick, MoreBox, Search, Cross } from "$icons/shapes";
	...
	<div class="mt-16 md:mt-[1.5vw]">
		<div class="flex items-center justify-between">
			...
			<div class="flex gap-3 md:gap-[1vw]">
				...
				<button class="btn h-max min-h-max border-none !bg-transparent p-0" on:click={todo}>
